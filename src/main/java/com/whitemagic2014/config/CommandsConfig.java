...
import com.whitemagic2014.command.impl.everywhere.TempGroupMagnetCommand;
...
public class CommandsConfig {
    ...
    @Autowired
    TempGroupMagnetCommand tempMagnet;

    @Autowired
    RollCommand roll;

    @Autowired
    SanCheckCommand sanCheckCommand;

    @Autowired
    MagnetCommand magnet;
    ...
    public Command[] initCommands() {
        Command[] commands = new Command[]{
                ...
                hello,
                checkdb,
                luck, roll, plan, decode, encode, caneat,magnet,tempMagnet,sanCheckCommand,
